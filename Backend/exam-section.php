...
<div class="tab-content" id="pills-tabContent">
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
       <table class="table">
        ...
        <?php 
          $Query = "SELECT * FROM semester AS s INNER JOIN exam_pdf AS e ON(s.regd = e.regd) WHERE e.status='OFF' AND s.dstatus='OFF' ";
          ...
          <td><?php echo $SrNo; ?></td>
           <td><?php echo $Regno; ?></td>
            <td><?php echo $Name; ?></td>
             ...
             <td><a href="exam-approve.php?regd=<?php echo $Regno; ?>"><span class="btn btn-warning">Verify</span></a></td>
        </tbody>
      <?php } ?>
      </table>
  </div>
  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
     <table class="table">
        ...
        <?php 
          $Query = "SELECT * FROM semester AS s INNER JOIN exam_pdf AS e ON(s.regd = e.regd) WHERE e.status='ON' AND s.dstatus='OFF' ";
          $Execute  = mysqli_query($Connection,$Query);
          $SrNo=0;
          while($DataRows = mysqli_fetch_array($Execute)) {
                $Id  = $DataRows["id"];
